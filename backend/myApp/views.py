...
def melodyGenerate(request):
    if request.method == 'POST':
        ...
        if audio_file:
            ...
            accompaniment.main(str(audio_file), drums=drums, piano=piano, length=30)
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                accompaniment_path = os.path.join(temp_dir, str(audio_file))

                vocals.export(vocals_path, format='wav')
                ins.export(instruments_path, format='wav')
                accom.export(accompaniment_path, format='wav')
                ...
                with zipfile.ZipFile(zip_buffer, 'a', zipfile.ZIP_DEFLATED, False) as zip_file:
                    ...
                    zip_file.write(accompaniment_path, 'accompaniment.wav')
